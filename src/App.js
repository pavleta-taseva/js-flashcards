        ...
        <main>
          <Routes>
            ...
            <Route element={<PrivateRoutes />}>
              ...
              <Route
                path='/flashcards-basic/:number'
                element={<FlashcardsBasic />}
              />
              <Route
                path='/flashcards-advanced'
                element={<FlashcardsAdvanced />}
              />
              <Route
                path='/flashcards-advanced/:number'
                element={<FlashcardsAdvanced />}
              />
              <Route path='/flashcards-web' element={<FlashcardsWeb />} />
              <Route
                path='/flashcards-web/:number'
                element={<FlashcardsWeb />}
              />
