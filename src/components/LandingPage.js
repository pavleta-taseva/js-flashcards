...
import imageTwo from '../../src/images/confused.png';
import { Link, Outlet } from 'react-router-dom';
import DemoFlashcard from './DemoFlashcard';
import Home from './User/Home/Home.js';

function LandingPage() {
    const link = <Link className="links" to="/register" alt="Register page">Register</Link>;
        ...
        <div>
            ...
            <section className="main-info">
                <div className="website-info">
                    ...
                    <div className="two" style={{ backgroundImage: `url(${imageTwo})` }}></div>
