        ...
        {isLogged ? (
          <div className='user'>
            ...
            <li className={splitLocation[1] === "profile" ? "active" : ""}>
              <NavLink
                to={`/profile/${userId}`}
                alt='Flashcard Trainer Profile page'
              >
                <span className='nav-icon'>
            ...
            <li className={splitLocation[1] === "my-cards" ? "active" : ""}>
              <NavLink
                to={`/my-cards/${userId}`}
                alt='Flashcard Trainer My cards page'
              >
                <span className='nav-icon'>
            ...
            <li className={splitLocation[1] === "flashcards" ? "active" : ""}>
              <NavLink
                ...
                alt='Flashcard Trainer Create page'
              >
                <span className='nav-icon'>
            ...
            <li className={splitLocation[1] === "practice" ? "active" : ""}>
              <NavLink
                to={`/practice/${userId}`}
                alt='Flashcard Trainer Practice page'
              >
                <span className='nav-icon'>
          ...
          <div className='guest'>
            ...
            <li className={splitLocation[1] === "collections" ? "active" : ""}>
              <NavLink
                to='/collections'
                alt='Flashcard Trainer Collections page'
              >
                <span className='nav-icon'>
            ...
            <li className={splitLocation[1] === "contact" ? "active" : ""}>
              <NavLink to='/contact' alt='Contact form'>
                <span className='nav-icon'>
